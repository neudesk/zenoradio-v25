class SummaryListenersByContentBroadcast < ActiveRecord::Base
  ...
  belongs_to :data_broadcast, foreign_key: :broadcast_id
end

# == Schema Information
#
# Table name: summary_listeners_by_content_broadcast
#
...
#
#  date                                             (date)
#  fk_summary_listeners_by_content_broadcast_1_idx  (broadcast_id)
#
